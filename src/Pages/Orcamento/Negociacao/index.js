...
import Negociacao from '../../../components/GestaoOrcamento/negociacao';
...
function TelaOrcamentoNegociacao() {
            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'Orcamento'} content2={'orcamentonegociacao'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'Orcamento'} content2={'orcamentonegociacao'}></BarraLateral>
                        <Negociacao content={pesquisa}></Negociacao>
                    </div>
                </div>
            )}
        </>
...
export default TelaOrcamentoNegociacao;