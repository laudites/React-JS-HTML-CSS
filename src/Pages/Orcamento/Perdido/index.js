...
import Perdido from '../../../components/GestaoOrcamento/perdido';
            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'Orcamento'} content2={'orcamentoperdido'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'Orcamento'} content2={'orcamentoperdido'}></BarraLateral>
                        <Perdido content={pesquisa}></Perdido>
                    </div>
                </div>
            )}
        </>
...
export default TelaOrcamentoPerdido;