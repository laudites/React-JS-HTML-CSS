            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content="Orcamento" content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content="Orcamento"></BarraLateral>
                        <GestaoOrcamento content={pesquisa}></GestaoOrcamento>
                    </div>
                </div>
            )}
        </>
