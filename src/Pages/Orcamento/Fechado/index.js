...
import Fechado from '../../../components/GestaoOrcamento/fechado';
            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'Orcamento'} content2={'orcamentofechado'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'Orcamento'} content2={'orcamentofechado'}></BarraLateral>
                        <Fechado content={pesquisa}></Fechado>
                    </div>
                </div>
            )}
        </>
...
export default TelaOrcamentoFechado;