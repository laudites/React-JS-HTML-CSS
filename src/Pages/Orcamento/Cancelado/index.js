            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'Orcamento'} content2={'orcamentocancelado'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'Orcamento'} content2={'orcamentocancelado'}></BarraLateral>
                        <Cancelado content={pesquisa}></Cancelado>
                    </div>
                </div>
            )}
        </>
...
export default TelaOrcamentoCancelado;