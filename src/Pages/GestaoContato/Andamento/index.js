...
import ContatoAndamento from '../../../components/gestaoContato/andamento';
            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'GestaoContato'} content2={'gestaocontatoAndamento'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'GestaoContato'} content2={'gestaocontatoAndamento'}></BarraLateral>
                        <ContatoAndamento content={pesquisa}></ContatoAndamento>
                    </div>
                </div>
            )}
        </>
...
export default TelaContatoAndamento;