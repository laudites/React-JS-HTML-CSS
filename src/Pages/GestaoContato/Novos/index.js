...
*/}
                        ...
                        {width < 600 && (
                            <BarraLateral content={'GestaoContato'} content2={'gestaocontatoNovos'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'GestaoContato'} content2={'gestaocontatoNovos'}></BarraLateral>
                        <ContatoNovo content={pesquisa}></ContatoNovo>
                    </div>
                </div>
            )}
        </>
...
export default TelaContatoNovos;