            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'GestaoPedidos'} content2={'gestaopedidonaoiniciado'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'GestaoPedidos'} content2={'gestaopedidonaoiniciado'}></BarraLateral>
                        <NaoIniciado content={pesquisa}></NaoIniciado>
                    </div>
                </div>
            )}
        </>
...
export default TelaNaoIniciado;