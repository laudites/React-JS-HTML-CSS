            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'GestaoPedidos'} content2={'gestaopedidoemprocesso'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'GestaoPedidos'} content2={'gestaopedidoemprocesso'}></BarraLateral>
                        <EmAndamento content={pesquisa}></EmAndamento>
                    </div>
                </div>
            )}
        </>
