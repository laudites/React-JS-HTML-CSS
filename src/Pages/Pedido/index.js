            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'GestaoPedidos'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'GestaoPedidos'}></BarraLateral>
                        <DashBoard content={pesquisa}></DashBoard>
                    </div>
                </div>
            )}
        </>
