...
function TelaFinalizado() {
    ...
    /*if (sessionStorage.getItem("pedidoPesquisa") !== "") {
        setPesquisa(sessionStorage.getItem("pedidoPesquisa"))
    }*/
            ...
            {CheckToken && (
                <div>
                    <div>
                        ...
                        {width < 600 && (
                            <BarraLateral content={'GestaoPedidos'} content2={'gestaopedidofinalizado'} content3={showBarraLateral}></BarraLateral>
                        )}
                    </div>
                    <div className="container-fluid page-body-wrapper">
                        <BarraLateral content={'GestaoPedidos'} content2={'gestaopedidofinalizado'}></BarraLateral>
                        <Finalizado content={pesquisa}></Finalizado>
                    </div>
                </div>
            )}
        </>
