...
function TabelaEmAndamento(content) {
    ...
    const pedidoFiltrado = pedidoEmAndamento?.filter(e => e.numeroPedido.includes(Result))

    const [detalhesExpositor, setDetalhesExpositor] = useState([{ "progressoPorcent": "EM PROCESSO" }]);
    const [detalhesInstalacoes, setDetalhesInstalacoes] = useState([{ "progressoPorcent": "EM PROCESSO" }]);
    const [detalhesSMR, setDetalhesSMR] = useState([{ "progressoPorcent": "EM PROCESSO" }]);
    const [detalhesCamaras, setDetalhesCamaras] = useState([{ "progressoPorcent": "EM PROCESSO" }]);
    ...
    async function SubPedido(numPedidos, porcentagem) {
        ...
        const resultExpositor = await PedidosDetalhes("EM PROCESSO", numPedidos, "EXPOSITOR")
        const resultInstalacoes = await PedidosDetalhes("EM PROCESSO", numPedidos, "INSTALAÇÕES")
        const resultSMR = await PedidosDetalhes("EM PROCESSO", numPedidos, "SMR")
        const resultCamaras = await PedidosDetalhes("EM PROCESSO", numPedidos, "CÂMARAS")
    ...
    useEffect(() => {
        let valor = true;
        PedidosGeral("EM PROCESSO")
            .then(items => {
                if (valor) {
                    setPedidoEmAndamento(items);
                }
            })
        return () => valor = false;
    }, [])
                                                            ...
                                                            <div className="expanded-table-normal-cell">
                                                                <div className="mr-2 mb-4">
                                                                    <div>
                                                                        ...
                                                                        <div id="st-02">{detalhesExpositor[0].progressoPorcent !== "EM PROCESSO" &&
                                                                            <div className="progress">
                                                                            ...
                                                                            {detalhesExpositor[0].progressoPorcent === "EM PROCESSO" && <h6 style={{ margin: "5px" }}>Não contém</h6>}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                {detalhesExpositor[0].progressoPorcent !== "EM PROCESSO" &&
                                                                    <div className="mr-2">
                                                            ...
                                                            <div className="expanded-table-normal-cell">
                                                                <div className="mr-2 mb-4">
                                                                    <div className="bp01">
                                                                        ...
                                                                        <div id="st-02">{detalhesCamaras[0].progressoPorcent !== "EM PROCESSO" &&
                                                                            <div className="progress">
                                                                                <div className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                                                                                    style={{ width: detalhesCamaras[0].progressoPorcent + "%" }}>{detalhesCamaras[0].progressoPorcent} %</div>
                                                                            </div>
                                                                        }
                                                                            {detalhesCamaras[0].progressoPorcent === "EM PROCESSO" && <h6 style={{ margin: "5px" }}>Não contém</h6>}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                {detalhesCamaras[0].progressoPorcent !== "EM PROCESSO" &&
                                                                    <div className="mr-2">
                                                                        <p id="st-03">Data cadastrada</p>
                                                            ...
                                                            <div className="expanded-table-normal-cell">
                                                                <div className="mr-2 mb-3 d-flex">
                                                                    ...
                                                                    <div className="bp01">
                                                                        ...
                                                                        <div id="st-02">{detalhesSMR[0].progressoPorcent !== "EM PROCESSO" &&
                                                                            <div className="progress">
                                                                                <div className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                                                                                    style={{ width: detalhesSMR[0].progressoPorcent + "%" }}>{detalhesSMR[0].progressoPorcent} %</div>
                                                                            </div>
                                                                        }
                                                                            {detalhesSMR[0].progressoPorcent === "EM PROCESSO" && <h6 style={{ margin: "5px" }}>Não contém</h6>}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                {detalhesSMR[0].progressoPorcent !== "EM PROCESSO" &&
                                                                    <div className="mr-2">
                                                                        <p id="st-03">Data cadastrada</p>
                                                            ...
                                                            <div className="expanded-table-normal-cell">
                                                                <div className="mr-2 mb-3 d-flex">
                                                                    <div className="bp01">
                                                                        ...
                                                                        <div id="st-02">{detalhesInstalacoes[0].progressoPorcent !== "EM PROCESSO" &&
                                                                            <div className="progress">
                                                                                <div className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
