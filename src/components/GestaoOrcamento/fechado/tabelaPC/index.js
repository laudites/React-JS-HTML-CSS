...
function TabelaFechado(content) {
        ...
        <table id="example" className="display expandable-table" style={{ width: "100%" }}>
            ...
            <tbody>
                {pedidoFiltrado?.map((e) => (
                    ...
                    <>
                        <tr key={e.numeroOrcamento} className={showPedidoArrow} onClick={() => SubPedido('Fechado', e.numeroOrcamento)} id="barraProgresso">
