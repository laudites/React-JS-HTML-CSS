...
function TabelaEmAberto(content) {
        ...
        <table id="example" className="display expandable-table" style={{ width: "100%" }}>
            ...
            <tbody>
                {pedidoFiltrado?.map((e) => (
                    ...
                    <>
                        <tr key={e.numeroOrcamento} className={showPedidoArrow} onClick={() => SubPedido('Em aberto', e.numeroOrcamento)} id="barraProgresso">
