...
function TabelaEmPendentes(content) {
    const [ListaContatoPendentes, setListaContatoPendentes] = useState();
    const [DadosContatoPendentes, setDadosContatoPendentes] = useState();

    useEffect(() => {
        QuantidadeContatosPendentes().then(itens => { setListaContatoPendentes(itens) });
    }, []);
    ...
    async function SubPedido(cnpj) {
        await DadosContatos(cnpj).then(itens => { setDadosContatoPendentes(itens) });
        setLoading(true);
        setNumPedido(cnpj);
                                                            ...
                                                            <div className="cell-hilighted subtelaroxo" style={{ display: "grid", margin: "5px", minWidth: "200px" }}>
                                                                ...
                                                                <div className="mr-2 min-width-cell" style={{ display: "grid" }}>
                                                                    <div>
                                                                        ...
                                                                        <p style={{ fontSize: "0.7rem" }}>{DadosContatoPendentes[0].nomE_FANTASIA}</p>
                                                                    </div>
                                                                    <div>
                                                                        <h6 id="st-01">Porte</h6>
                                                                        <p style={{ fontSize: "0.7rem" }}>{DadosContatoPendentes[0].porte}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="expanded-table-normal-cell" style={{ margin: "5px" }}>
                                                                <div className="mr-2 mb-4">
                                                                    <div className="bp01">
                                                                        ...
                                                                        <p style={{ margin: "5px" }}>{DadosContatoPendentes[0].atividadE_ECONOMICA}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="expanded-table-normal-cell" style={{ margin: "5px", minWidth: "200px" }}>
                                                                <div className="mr-2 mb-4">
                                                                    <div className="bp01">
                                                                        ...
                                                                        <h6 style={{ margin: "5px" }}>
                                                                            <p>Logradouro:</p>{`${DadosContatoPendentes[0].endereco} Nº${DadosContatoPendentes[0].numero}`}
                                                                            <br />
                                                                            <br />
                                                                            <p>Bairro:</p>{`${DadosContatoPendentes[0].bairro}`}
                                                                            <br />
                                                                            <br />
                                                                            <p>UF/Cidade:</p>{`${DadosContatoPendentes[0].uf}/${DadosContatoPendentes[0].cidade}`}
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="expanded-table-normal-cell" style={{ margin: "5px", minWidth: "200px" }}>
                                                                <div className="mr-2 mb-4">
                                                                    <div className="bp01">
                                                                        ...
                                                                        <p>Celular 1:</p>{`${DadosContatoPendentes[0].ceL1}`}
                                                                        <p>Celular 2:</p>{`${DadosContatoPendentes[0].ceL2}`}
                                                                        <p>Telefone 1:</p>{`${DadosContatoPendentes[0].teL1}`}
                                                                        <p>Telefone 2:</p>{`${DadosContatoPendentes[0].teL2}`}
                                                                        <p>Telefone adicional:</p>{`${DadosContatoPendentes[0].fonE_ADICIONAL}`}
                                                                    </div>
                                                                </div>
                                                            </div>
...
export default TabelaEmPendentes;