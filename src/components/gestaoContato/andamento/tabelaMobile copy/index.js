                                                            ...
                                                            <div className="expanded-table-normal-cell">
                                                                {showExpositor &&
                                                                    <>
                                                                        <div className="mr-2 mb-4">
                                                                            ...
                                                                            <p>{detalhesExpositor[0].progressoPorcent !== "NÃO INICIADO" &&
                                                                ...
                                                                {showCamaras &&
                                                                    <>
                                                                        <div className="mr-2 mb-4">
                                                                            <h5>Linha: Camaras</h5>
                                                                            <p>{detalhesCamaras[0].progressoPorcent !== "NÃO INICIADO" &&
                                                                                <div className="progress">
                                                                                    <div className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                                                                ...
                                                                {showSMR &&
                                                                    <>
                                                                        <div className="mr-2 mb-4">
                                                                            <h5>Linha: SMR</h5>
                                                                            <p>{detalhesSMR[0].progressoPorcent !== "NÃO INICIADO" &&
                                                                                <div className="progress">
                                                                                    <div className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
                                                                ...
                                                                {showInstalacoes &&
                                                                    <>
                                                                        <div className="mr-2 mb-4">
                                                                            ...
                                                                            <p>{detalhesInstalacoes[0].progressoPorcent !== "NÃO INICIADO" &&
                                                                                <div className="progress">
                                                                                    <div className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"
